...
import ir.mhajisoft.miniaccountant.data.bank.BankDirectoryRepository
...
import ir.mhajisoft.miniaccountant.data.secret.SecretVault
...
class VaultRepository @Inject constructor(
    ...
    suspend fun saveCard(
        ...
        val bank = (match as? ir.mhajisoft.miniaccountant.domain.bank.BankMatch.Known)?.bank
