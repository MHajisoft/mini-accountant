package ir.mhajisoft.hesabres.data.backup
...
import ir.mhajisoft.hesabres.data.cloud.CloudBackupClient
import ir.mhajisoft.hesabres.data.cloud.CloudKind
...
import ir.mhajisoft.hesabres.domain.backup.BACKUP_FILE_EXTENSION
import ir.mhajisoft.hesabres.domain.backup.BACKUP_SCHEMA_VERSION
import ir.mhajisoft.hesabres.domain.backup.BackupCard
import ir.mhajisoft.hesabres.domain.backup.BackupManifest
import ir.mhajisoft.hesabres.domain.backup.BackupSanitizer
import ir.mhajisoft.hesabres.domain.backup.PassphraseKdf
...
class BackupRepository @Inject constructor(
    ...
    private val drive: ir.mhajisoft.hesabres.data.cloud.DriveBackupClient,
    private val oneDrive: ir.mhajisoft.hesabres.data.cloud.OneDriveBackupClient,
) {
    ...
    private fun ir.mhajisoft.hesabres.data.local.entity.BackupMetadataEntity.toDomainCompat() =
        ir.mhajisoft.hesabres.domain.model.BackupMetadata(
            id, ir.mhajisoft.hesabres.domain.model.BackupProvider.valueOf(provider),
