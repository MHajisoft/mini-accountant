...
import ir.mhajisoft.hesabres.domain.ledger.OpeningBalancePoster
...
class LedgerRepository @Inject constructor(
    ...
    suspend fun closeCurrentAndStartNext(now: Long): FiscalYear {
        ...
        snapshots.upsertAll(
            closings.map { ab ->
                ir.mhajisoft.hesabres.data.local.entity.BalanceSnapshotEntity(
        ...
        closings.forEach { ab ->
            openings.upsert(
                ir.mhajisoft.hesabres.domain.model.AccountOpeningBalance(
