package ir.mhajisoft.hesabres.domain.backup
...
const val APP_ID = "ir.mhajisoft.hesabres"
const val LEGACY_APP_ID = "ir.mhajisoft.miniaccountant"

fun isKnownAppId(appId: String): Boolean = appId == APP_ID || appId == LEGACY_APP_ID
